...
namespace LinqConsoleApp
{
    public class LinqSamples
    {
        ...
        */
        ...
        public void Task4()
        {
            var res = Emps.Where(e => e.Salary == Emps.Max(e => e.Salary)).ToList();
        ...
        public void Task9()
        {
            ...
            /*   var res1 = Emps
               .Where(e => e.Job == "Frontend programmer")
               .OrderByDescending(e => e.HireDate).Take(1).ToList();*/
